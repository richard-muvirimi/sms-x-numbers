          ...
          <Stack spacing={3}>
            <Box>
              <Typography paragraph>
                SMS X Numbers helps you process large sets of phone numbers for SMS campaigns.
                Upload your numbers via file (CSV, Excel, or text) or paste them directly into the text area.
                The system handles various number formats including international (+263771234567) and local (0771234567),
                standardizing them all into a consistent format for your campaign.
              </Typography>
            </Box>
            ...
            <Box>
              ...
              <Typography paragraph>
                The file upload option provides flexibility in importing your phone numbers:
              </Typography>
              <ul>
              ...
              <Typography paragraph>
                The text field provides a direct way to input phone numbers:
              </Typography>
              <ul>
              ...
              <Typography paragraph>
                The country code is essential for proper number formatting and validation:
              </Typography>
              <ul>
                <Typography component="li">Determines how local numbers (starting with 0) are converted to international format</Typography>
              ...
              <Typography paragraph>
                The chunk size controls how your numbers are split for processing:
              </Typography>
              <ul>
            ...
            <Box>
              ...
              <Typography paragraph>
                When you submit your numbers, the system follows these steps:
              </Typography>
              <ol>
                <Typography component="li">Your input (file or text) is parsed to extract individual phone numbers</Typography>
                <Typography component="li">Each number is validated and standardized using the selected country code:
                  <ul>
                    <Typography component="li" sx={{ mt: 1 }}>Local numbers have the country code prefix added</Typography>
              ...
              <Typography paragraph sx={{ mt: 2 }}>
                The processed files remain available for 30 days, allowing you to download individual chunks
                or the complete set of numbers as needed for your SMS campaigns.
              </Typography>
            </Box>
          </Stack>
        </Paper>
