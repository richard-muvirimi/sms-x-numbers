...
import { UploadResponse, Country, CountriesResponse } from '@/types/api';
          ...
          <Stack spacing={2}>
            <Box>
              <Typography paragraph>
                Upload a file or paste phone numbers to split them into manageable chunks. We support various formats including CSV, Excel, and text files.
                Numbers can be in international format (+263771234567) or local format (0771234567).
                <Link href="/how-it-works" sx={{ ml: 1 }} underline="hover">Learn more about how it works</Link>
              </Typography>
              <Button
                variant="outlined"
