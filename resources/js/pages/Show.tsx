                ...
                <Paper elevation={2}>
                    <Box sx={{ p: 3 }}>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 4 }}>
                            <Box>
                                <Button variant="outlined" href="/" sx={{ mr: 2 }} startIcon={<ArrowBackIcon />}>
                                    Back to Home
                                </Button>
                            </Box>
                        ...
                        <Stack spacing={4}>
                            ...
                            <Box>
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid size={4}>
                                        <Paper variant="outlined" sx={{ p: 2, textAlign: 'center', bgcolor: theme.palette.success.light }}>
                                            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 1 }}>
                                    ...
                                    <Grid size={4}>
                                        <Paper variant="outlined" sx={{ p: 2, textAlign: 'center', bgcolor: theme.palette.error.light }}>
                                            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 1 }}>
